...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/gr.c', 'src/track_min_distance.c', 'src/modify_orbits_direct.c', 'src/core.c', 'src/rebxtools.c', 'src/type_I_migration.c', 'src/input.c', 'src/lense_thirring.c', 'src/integrate_force.c', 'src/interpolation.c', 'src/gravitational_harmonics.c', 'src/modify_mass.c', 'src/inner_disk_edge.c', 'src/gr_full.c', 'src/gr_potential.c', 'src/output.c', 'src/integrator_implicit_midpoint.c', 'src/integrator_euler.c', 'src/tides_constant_time_lag.c', 'src/stochastic_forces.c', 'src/steppers.c', 'src/gas_damping_timescale.c', 'src/tides_spin.c', 'src/exponential_migration.c', 'src/linkedlist.c', 'src/integrator_rk2.c', 'src/modify_orbits_forces.c', 'src/central_force.c', 'src/yarkovsky_effect.c', 'src/integrator_rk4.c', 'src/radiation_forces.c', 'src/gas_dynamical_friction.c'],
